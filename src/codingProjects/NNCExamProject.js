...
import {Code, Text, H2, H5, H4, H3} from '@blueprintjs/core';
...
export class NNCExamProject extends React.PureComponent{
    render(){
		let example = {
			uro: require('./resources/XORNNOutput.png')
		}
        let InTheRain = {
			uri : require('./resources/XORNNOutput.png')
		}
        let structure = {
			uri : require('./resources/structure.png')
		}
